...
class SmartAction
{
    ...
    public const ACTION_SET_UNIT_MOVEMENT_FLAGS            = 204; //  flags
    public const ACTION_SET_COMBAT_DISTANCE                = 205; //  combatDistance
    public const ACTION_DISMOUNT                           = 206; //  none
    public const ACTION_AC_SET_HOVER                       = 207; //  0/1
    public const ACTION_ADD_IMMUNITY                       = 208; //  type, id, value
    public const ACTION_REMOVE_IMMUNITY                    = 209; //  type, id, value
    public const ACTION_FALL                               = 210; //  none
    public const ACTION_SET_EVENT_FLAG_RESET               = 211; //  0/1
    public const ACTION_STOP_MOTION                        = 212; //  stopMoving, movementExpired
    public const ACTION_NO_ENVIRONMENT_UPDATE              = 213; //  none
    public const ACTION_ZONE_UNDER_ATTACK                  = 214; //  none
    public const ACTION_LOAD_GRID                          = 215; //  none
    public const ACTION_MUSIC                              = 216; //  SoundId, onlySelf, type
    public const ACTION_RANDOM_MUSIC                       = 217; //  SoundId1, SoundId2, SoundId3, SoundId4, onlySelf, type
    public const ACTION_CUSTOM_CAST                        = 218; //  spellId, castflag, bp0, bp1, bp2
    public const ACTION_CONE_SUMMON                        = 219; //  entry, duration, dist between rings, dist between summons, cone length, cone width
    public const ACTION_PLAYER_TALK                        = 220; //  acore_string.entry, yell (0/1)
    ...
    public const ACTION_SUMMON_RADIAL                      = 228; //  summonEntry, summonDuration, repetitions, startAngle, stepAngle, dist
    public const ACTION_PLAY_SPELL_VISUAL                  = 229; //  visualId, visualIdImpact
    public const ACTION_FOLLOW_GROUP                       = 230; //  followState, followType, dist
    public const ACTION_SET_ORIENTATION_TARGET             = 231; //  type, target_type, target_param1-4
    public const ACTION_WAYPOINT_START                     = 232; //  pathId, repeat, pathSource
    public const ACTION_WAYPOINT_DATA_RANDOM               = 233; //  pathId1, pathId2, repeat
    public const ACTION_MOVEMENT_STOP                      = 234; //  none
    public const ACTION_MOVEMENT_PAUSE                     = 235; //  timer
    public const ACTION_MOVEMENT_RESUME                    = 236; //  timerOverride
    public const ACTION_WORLD_SCRIPT                       = 237; //  eventId, param
    public const ACTION_DISABLE_REWARD                     = 238; //  reputation 0/1, loot 0/1
    public const ACTION_SET_ANIM_TIER                      = 239; //  animtier
    public const ACTION_SET_GOSSIP_MENU                    = 240; //  gossipMenuId
    public const ACTION_SUMMON_GAMEOBJECT_GROUP            = 241; //  group
    ...
    private array $data = array(
        ...
        self::ACTION_SET_UNIT_MOVEMENT_FLAGS            => [null, null, null, null, null, null, 0],  // flags
        self::ACTION_SET_COMBAT_DISTANCE                => [null, null, null, null, null, null, 0],  // combatDistance
        self::ACTION_DISMOUNT                           => [null, null, null, null, null, null, 0],  // none
        self::ACTION_AC_SET_HOVER                       => [null, null, null, null, null, null, 0],  // 0/1
        self::ACTION_ADD_IMMUNITY                       => [null, null, null, null, null, null, 0],  // type, id, value
        self::ACTION_REMOVE_IMMUNITY                    => [null, null, null, null, null, null, 0],  // type, id, value
        self::ACTION_FALL                               => [null, null, null, null, null, null, 0],  // none
        self::ACTION_SET_EVENT_FLAG_RESET               => [null, null, null, null, null, null, 0],  // 0/1
        self::ACTION_STOP_MOTION                        => [null, null, null, null, null, null, 0],  // stopMoving, movementExpired
        self::ACTION_NO_ENVIRONMENT_UPDATE              => [null, null, null, null, null, null, 0],  // none
        self::ACTION_ZONE_UNDER_ATTACK                  => [null, null, null, null, null, null, 0],  // none
        self::ACTION_LOAD_GRID                          => [null, null, null, null, null, null, 0],  // none
        self::ACTION_MUSIC                              => [Type::SOUND, null, null, null, null, null, 0],  // SoundId, onlySelf, type
        self::ACTION_RANDOM_MUSIC                       => [Type::SOUND, Type::SOUND, Type::SOUND, Type::SOUND, null, null, 0],  // SoundId1-4, onlySelf, type
        self::ACTION_CUSTOM_CAST                        => [Type::SPELL, null, null, null, null, null, 0],  // spellId, castflag, bp0, bp1, bp2
        self::ACTION_CONE_SUMMON                        => [Type::NPC, ['formatTime', 10, false], null, null, null, null, 0],  // entry, duration, dist rings, dist summons, cone length, cone width
        self::ACTION_PLAYER_TALK                        => [null, null, null, null, null, null, 0],  // acore_string.entry, yell (0/1)
        ...
        self::ACTION_SUMMON_RADIAL                      => [Type::NPC, ['formatTime', 10, false], null, null, null, null, 0],  // entry, duration, repetitions, startAngle, stepAngle, dist
        self::ACTION_PLAY_SPELL_VISUAL                  => [null, null, null, null, null, null, 0],  // visualId, visualIdImpact
        self::ACTION_FOLLOW_GROUP                       => [null, null, null, null, null, null, 0],  // followState, followType, dist
        self::ACTION_SET_ORIENTATION_TARGET             => [null, null, null, null, null, null, 0],  // type, target_type, params
        self::ACTION_WAYPOINT_START                     => [null, null, null, null, null, null, 0],  // pathId, repeat, pathSource
        self::ACTION_WAYPOINT_DATA_RANDOM               => [null, null, null, null, null, null, 0],  // pathId1, pathId2, repeat
        self::ACTION_MOVEMENT_STOP                      => [null, null, null, null, null, null, 0],  // none
        self::ACTION_MOVEMENT_PAUSE                     => [['formatTime', 10, true], null, null, null, null, null, 0],  // timer
        self::ACTION_MOVEMENT_RESUME                    => [null, null, null, null, null, null, 0],  // timerOverride
        self::ACTION_WORLD_SCRIPT                       => [null, null, null, null, null, null, 0],  // eventId, param
        self::ACTION_DISABLE_REWARD                     => [null, null, null, null, null, null, 0],  // reputation 0/1, loot 0/1
        self::ACTION_SET_ANIM_TIER                      => [null, null, null, null, null, null, 0],  // animtier
        self::ACTION_SET_GOSSIP_MENU                    => [null, null, null, null, null, null, 0],  // gossipMenuId
        self::ACTION_SUMMON_GAMEOBJECT_GROUP            => [null, null, null, null, null, null, 0],  // group
    );
