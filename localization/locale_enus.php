...
/*105*/     SmartEvent::EVENT_AREA_CASTING            => ['When %11$s targets in area are casting', 'Repeat every %s'],
...
/*110*/     SmartEvent::EVENT_IS_IN_MELEE_RANGE       => ['(%6$d)?Not in:In; melee range', 'Repeat every %s'],
        ),
        'eventFlags'    => array(
