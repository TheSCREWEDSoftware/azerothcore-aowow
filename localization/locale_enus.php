...
/* 30*/     SmartEvent::EVENT_CHARMED_TARGET          => ['When charming #target#', ''],
            ...
            SmartEvent::EVENT_ESCORT_START            => ['Start escort path from (%1$d)?waypoint #[b]%1$d[/b]:any waypoint;(%2$d)? on path #[b]%2$d[/b]:;', ''],
/* 40*/     SmartEvent::EVENT_ESCORT_REACHED         => ['Reaching (%1$d)?escort waypoint #[b]%1$d[/b]:any escort waypoint;(%2$d)? on path #[b]%2$d[/b]:;', ''],
...
/* 50*/     SmartEvent::EVENT_QUEST_REWARDED          => null,
            ...
            SmartEvent::EVENT_ESCORT_PAUSED           => ['Pausing escort path on (%1$d)?waypoint #[b]%1$d[/b]:any waypoint;(%2$d)? on path #[b]%2$d[/b]:;', ''],
            SmartEvent::EVENT_ESCORT_RESUMED          => ['Resuming escort path on (%1$d)?waypoint #[b]%1$d[/b]:any waypoint;(%2$d)? on path #[b]%2$d[/b]:;', ''],
            SmartEvent::EVENT_ESCORT_STOPPED          => ['Stopping escort path on (%1$d)?waypoint #[b]%1$d[/b]:any waypoint;(%2$d)? on path #[b]%2$d[/b]:;', ''],
            SmartEvent::EVENT_ESCORT_ENDED            => ['Ending escort path on (%1$d)?waypoint #[b]%1$d[/b]:any waypoint;(%2$d)? on path #[b]%2$d[/b]:;', ''],
...
/*101*/     SmartEvent::EVENT_NEAR_PLAYERS            => ['(%1$d)?At least %1$d:Any; player(%1$d != 1)?s:; within %2$dm', 'Repeat every %s'],
            SmartEvent::EVENT_NEAR_PLAYERS_NEGATION   => ['Fewer than (%1$d)?%1$d:any; player(%1$d != 1)?s:; within %2$dm', 'Repeat every %s'],
            SmartEvent::EVENT_NEAR_UNIT               => ['(%1$d)?At least %3$d [npc=%2$d]:any unit; within %4$dm', 'Repeat every %s'],
            SmartEvent::EVENT_NEAR_UNIT_NEGATION      => ['Fewer than (%3$d)?%3$d:any; (%2$d)?[npc=%2$d]:unit; within %4$dm', 'Repeat every %s'],
/*105*/     SmartEvent::EVENT_AREA_CASTING            => ['(%11$s)?After %11$s:Instantly;, hostile in area (%13$s)?at range %13$sy:in melee range; is casting', 'Repeat every %s'],
            SmartEvent::EVENT_AREA_RANGE              => ['(%11$s)?After %11$s:Instantly;, hostile in area (%13$s)?at range %13$sy:in melee range;', 'Repeat every %s'],
            SmartEvent::EVENT_SUMMONED_UNIT_EVADE     => ['My summoned (%1$d)?[npc=%1$d]:NPC; evaded', 'Cooldown: %s'],
            SmartEvent::EVENT_WAYPOINT_REACHED        => ['Reaching (%1$d)?waypoint #[b]%1$d[/b]:any waypoint;(%2$d)? on path #[b]%2$d[/b]:;', ''],
            SmartEvent::EVENT_WAYPOINT_ENDED          => ['Ending path on (%1$d)?waypoint #[b]%1$d[/b]:any waypoint;(%2$d)? at path #[b]%2$d[/b]:;', ''],
/*110*/     SmartEvent::EVENT_IS_IN_MELEE_RANGE       => ['(%11$s)?After %11$s:Instantly;, (%6$d)?not in:in; melee range(%5$d)? +%5$dy:;', 'Repeat every %s'],
        ),
        'eventFlags'    => array(
...
/*201*/     SmartAction::ACTION_MOVE_TO_POS_TARGET                 => ['Move #target# to waypoint #[b]%1$d[/b].', ''],
            SmartAction::ACTION_EXIT_VEHICLE                       => ['#target# exits vehicle.', ''],
            SmartAction::ACTION_SET_UNIT_MOVEMENT_FLAGS            => ['Set movement flags of #target# to [b]%1$d[/b].', ''],
/*204*/     SmartAction::ACTION_SET_COMBAT_DISTANCE                => ['Set combat distance of #target# to [b]%1$d[/b].', ''],
            SmartAction::ACTION_DISMOUNT                           => ['Dismount #target#.', ''],
            SmartAction::ACTION_AC_SET_HOVER                       => ['(%1$d)?Enable:Disable; hovering of #target#.', ''],
            SmartAction::ACTION_ADD_IMMUNITY                       => ['Add immunity to #target#: type [b]%1$d[/b] id [b]%2$d[/b] value [b]%3$d[/b].', ''],
            SmartAction::ACTION_REMOVE_IMMUNITY                    => ['Remove immunity from #target#: type [b]%1$d[/b] id [b]%2$d[/b] value [b]%3$d[/b].', ''],
/*209*/     SmartAction::ACTION_FALL                               => ['#target# falls.', ''],
/*211*/     SmartAction::ACTION_SET_EVENT_FLAG_RESET               => ['(%1$d)?Enable:Disable; event flag reset.', ''],
            SmartAction::ACTION_STOP_MOTION                        => ['Stop #target# motion.', '(%1$d)?Stop moving:; (%2$d)?Expire movement:;'],
            SmartAction::ACTION_NO_ENVIRONMENT_UPDATE              => ['Suppress environment update.', ''],
            SmartAction::ACTION_ZONE_UNDER_ATTACK                  => ['Trigger zone-under-attack for #target#.', ''],
/*215*/     SmartAction::ACTION_LOAD_GRID                          => ['Load grid for #target#.', ''],
            SmartAction::ACTION_MUSIC                              => ['Play music [sound=%1$d](%2$d)? on self:; type [b]%3$d[/b].', ''],
            SmartAction::ACTION_RANDOM_MUSIC                       => ['Play random music (%1$d)?[sound=%1$d]:;(%2$d)? / [sound=%2$d]:;(%3$d)? / [sound=%3$d]:;(%4$d)? / [sound=%4$d]:;.', ''],
            SmartAction::ACTION_CUSTOM_CAST                        => ['Custom cast [spell=%1$d] on #target#.', ''],
            SmartAction::ACTION_CONE_SUMMON                        => ['Summon [npc=%1$d] in a cone.(%2$d)? (disappears after %11$s):;', ''],
/*220*/     SmartAction::ACTION_PLAYER_TALK                        => ['Players say text #[b]%1$d[/b](%2$d)? as yell:.;', ''],
...
/*225*/     SmartAction::ACTION_SET_GUID                           => ['Send GUID of invoker/base-object to #target#.', ''],
            ...
            SmartAction::ACTION_SUMMON_RADIAL                      => ['Summon [npc=%1$d] in a ring.(%2$d)? (disappears after %11$s):;', ''],
            SmartAction::ACTION_PLAY_SPELL_VISUAL                  => ['Play spell visual [b]%1$d[/b](%2$d)? with impact [b]%2$d[/b]:; on #target#.', ''],
/*230*/     SmartAction::ACTION_FOLLOW_GROUP                       => ['Formation follow. State [b]%1$d[/b], type [b]%2$d[/b].', ''],
            SmartAction::ACTION_SET_ORIENTATION_TARGET             => ['Face #target# toward target type [b]%1$d[/b].', ''],
            SmartAction::ACTION_WAYPOINT_START                     => ['Start waypoint path [b]%1$d[/b](%2$d)? (repeat):; on #target#.', ''],
            SmartAction::ACTION_WAYPOINT_DATA_RANDOM               => ['Start random waypoint path [b]%1$d[/b] – [b]%2$d[/b](%3$d)? (repeat):; on #target#.', ''],
            SmartAction::ACTION_MOVEMENT_STOP                      => ['Stop movement of #target#.', ''],
/*235*/     SmartAction::ACTION_MOVEMENT_PAUSE                     => ['Pause movement of #target# for %11$s.', ''],
            SmartAction::ACTION_MOVEMENT_RESUME                    => ['Resume movement of #target#.', ''],
            SmartAction::ACTION_WORLD_SCRIPT                       => ['Fire world script event [b]%1$d[/b](%2$d)? param [b]%2$d[/b]:.;', ''],
            SmartAction::ACTION_DISABLE_REWARD                     => ['Disable reward for #target#.', '(%1$d)?No reputation:; (%2$d)?No loot:;'],
            SmartAction::ACTION_SET_ANIM_TIER                      => ['Set anim tier of #target# to [b]%1$d[/b].', ''],
/*240*/     SmartAction::ACTION_SET_GOSSIP_MENU                    => ['Set gossip menu of #target# to [b]%1$d[/b].', ''],
            SmartAction::ACTION_SUMMON_GAMEOBJECT_GROUP            => ['Spawn gameobject group [b]%1$d[/b].', ''],
        ),
...
/*201*/     SmartTarget::TARGET_PLAYER_WITH_AURA       => 'player(%2$d)? without:; [spell=%1$d](%3$d)? within %3$dm:;',
            SmartTarget::TARGET_RANDOM_POINT           => 'random point within %1$dm',
            SmartTarget::TARGET_ROLE_SELECTION         => 'role-selected units within %1$dm',
            SmartTarget::TARGET_SUMMONED_CREATURES     => 'summoned (%1$d)?[npc=%1$d]:creatures;',
/*205*/     SmartTarget::TARGET_INSTANCE_STORAGE       => 'instance storage index [b]%1$d[/b]',
            SmartTarget::TARGET_FORMATION              => 'formation (%2$d)?[npc=%2$d]:members;',
        ),
        'castFlags'     => array(
...
//      'noTarget'      => "To others without a target",
    ...
    'quest' => array(
        ...
        'breadcrumbQDesc'   => "Optional lead-in quests for this quest. Picking up either this quest or a breadcrumb quest makes the other unavailable.",
        'reqQ'          => "Requires",
