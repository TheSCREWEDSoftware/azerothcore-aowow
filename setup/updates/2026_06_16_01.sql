...
-- don't use unavailable trade skills to resolve reagent dependencies on Spell Detail Page
-- Source: https://github.com/Sarjuuk/aowow/commit/764ea1c7fa8807d1b5c2fec8ff6a42ae88a9b42d

DELETE FROM `aowow_setup_custom_data` WHERE (`command`, `entry`, `field`) IN (
    ('spell', 17579, 'cuFlags'),
    ('spell', 54020, 'cuFlags'),
    ('spell', 2336, 'cuFlags'),
    ('spell', 8366, 'cuFlags'),
